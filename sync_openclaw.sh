...
#   ./sync_openclaw.sh --dry-run    # show what would change, write nothing
#   DST=/path ./sync_openclaw.sh    # override the deploy target
#
...
DST="${DST:-$HOME/.openclaw/workspace/skills/party-planner}"
DRY=""
